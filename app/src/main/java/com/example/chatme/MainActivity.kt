...
//               }
                ...
                Button(
                    onClick = { nav.navigate(ChatScreenDestination) }, modifier = Modifier
                        .width(317.dp)
                        .height(58.dp)
                ) {
                ...
                TextButton(onClick = { nav.navigate(SinUpScreenDestination) }) {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Row(
               ...
               IconButton(onClick = { showbahet.value = true }) {
                ...
                Text (text = "                          Home", color = Color.Black, modifier = Modifier.align(CenterVertically), fontSize = 22.sp)
            }
        }
